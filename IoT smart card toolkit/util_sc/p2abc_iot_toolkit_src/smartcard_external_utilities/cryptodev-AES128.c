...
static int test_aes(int cfd)
{
    ...
    aes128cbc_ctx_init(&ctx, cfd, key1, sizeof(key1));
    ...
    aes128_encrypt(&ctx, iv1, plaintext1, plaintext1, AES_BLOCK_SIZE);
    ...
    aes128_ctx_init(&ctx, cfd, key2, sizeof(key2));
    ...
    /* Encrypt data.in to data.encrypted */
    aes128_encrypt(&ctx, iv2, plaintext2, plaintext2, AES_BLOCK_SIZE);
